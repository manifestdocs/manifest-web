...
<p>
  With your feature tree planned, agents can start implementing. Manifest tracks
  state and records history as work progresses.
</p>
...
<p>
  The agent finds the highest-priority proposed feature from the Now version.
</p>
...
<CodeBlock
  copyable={false}
  code={`Feature: OAuth Integration (●)
