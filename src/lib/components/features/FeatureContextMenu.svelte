      ...
      {#if isArchived}
        ...
        {#if onRestore}
          ...
          >
            <svg width="14" height="14" viewBox="0 0 16 16" fill="none">
              <path
                d="M2 8C2 4.68629 4.68629 2 8 2C10.5 2 12.5 3.5 13.4 5.5M14 8C14 11.3137 11.3137 14 8 14C5.5 14 3.5 12.5 2.6 10.5"
                stroke="currentColor"
                stroke-width="1.5"
        ...
        {#if onDelete}
          ...
          >
            <svg width="14" height="14" viewBox="0 0 16 16" fill="none">
              <path
                d="M5.5 5.5V12.5M8 5.5V12.5M10.5 5.5V12.5M2 4H14M6 4V2.5C6 2.22386 6.22386 2 6.5 2H9.5C9.77614 2 10 2.22386 10 2.5V4M3.5 4L4 13.5C4 14.0523 4.44772 14.5 5 14.5H11C11.5523 14.5 12 14.0523 12 13.5L12.5 4"
                stroke="currentColor"
                stroke-width="1.5"
                stroke-linecap="round"
                stroke-linejoin="round"
